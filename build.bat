...
7z a -tzip .\release\cnki-downloader-windows.zip .\release\cnki-downloader.exe
...
7z a -tzip .\release\cnki-downloader-linux.zip .\release\cnki-downloader
...
set GOOS=darwin
go build --ldflags="-s" -o .\release\cnki-downloader
7z a -tzip .\release\cnki-downloader-darwin.zip .\release\cnki-downloader
del .\release\cnki-downloader